...
Este informe detalla el proceso y los resultados de un modelo de clasificación implementado utilizando el coseno de la similitud con la biblioteca cosine_similarity. El objetivo del modelo es predecir las etiquetas de atributos a partir de características como la , la categoría (categoria) y el estado (state) de un conjunto de datos.
